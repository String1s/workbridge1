...
#Estadistica
@login_required
def estadisticas_proyectos(request):
    total_proyectos = Proyecto.objects.count()
    promedio_colaboradores = Proyecto.objects.aggregate(Avg('colaboradores'))['colaboradores__avg']
    max_tiempo_desarrollo = Proyecto.objects.aggregate(Max('tiempo_desarrollo'))['tiempo_desarrollo__max']
    min_tiempo_desarrollo = Proyecto.objects.aggregate(Min('tiempo_desarrollo'))['tiempo_desarrollo__min']
    proyectos_por_categoria = Proyecto.objects.values('categoria').annotate(total=Count('id_proyecto'))

    context = {
        'total_proyectos': total_proyectos,
        'promedio_colaboradores': promedio_colaboradores,
        'max_tiempo_desarrollo': max_tiempo_desarrollo,
        'min_tiempo_desarrollo': min_tiempo_desarrollo,
        'proyectos_por_categoria': list(proyectos_por_categoria),
    }
    return render(request, 'interfaz_admin/estadisticas_proyectos.html', context)
...
def estadisticas(request):
    ...
    return render(request, 'interfaz_empresa/estadisticas.html', context)
